package com.easyExcel.interceptor;
...
/**
 * @author zhangling 2021/4/23 10:23
 */
public class DropWriteHandler2 implements SheetWriteHandler {

    private static final Logger logger = LoggerFactory.getLogger(DropWriteHandler2.class);
    ...
    public void afterSheetCreate(WriteWorkbookHolder writeWorkbookHolder, WriteSheetHolder writeSheetHolder) {
        ...
        List<String> classGradeList = new ArrayList<>();
        classGradeList.add("班级1");
        classGradeList.add("班级2");
        classGradeList.add("班级3");
        classGradeList.add("班级3");
        classGradeList.add("班级3");
        ...
        for (int i = 0, length = classGrades.length; i < length; i++) {
            ...
            hidden.createRow(i).createCell(0).setCellValue(classGrades[i]);
        }
        ...
        String drop = hiddenName + "!$A$1:$A$" + classGrades.length;
        DataValidationConstraint constraint8 = helper.createFormulaListConstraint(drop);
